...
% * <dri2000@free.fr> 2016-03-21T16:15:23.989Z:
%
% > %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% > %
% > % Welcome to writeLaTeX --- just edit your LaTeX on the left,
...
% >   \node[name=Cd, below of=Zn, Metal] {\NaturalElementTextFormat{48}{112.41}{Cd}{Cadmium}};
% >   \node[name=Hg, below of=Cd, Metal] {\NaturalElementTextFormat{80}{200.59}{Hg}{Mercury}};
% >   \node[name=Uub, below of=Hg, Metal] {\SyntheticElementTextFormat
%
% ^.
...
%% Actinide
  ...
  \node[name=U, right of=Pa, LanthanideActinide] {\NaturalElementTextFormat{92}{238.03}{URA}{Uranium}};
