...
// 数组排序
int BubbleSort(StuNodePt, int, int (*)(const void *, const void *));
// 功能函数
...
int main(void)
{
    ...
    BubbleSort(Stu, N, Greater);
    Traversal(Stu, N, Output);
    printf("\n");

    BubbleSort(Stu, N, Lesser);
    Traversal(Stu, N, Output);
    printf("\n");
...
// 采用冒泡排序对数组排序
int BubbleSort(StuNodePt pa, int n, int (*pf)(const void *, const void *))
{
    int i = 0, j = 0;
    int counter = 0;
