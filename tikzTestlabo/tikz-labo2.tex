...
\tikzset{% 设置颜色
  couleur/.style={fill={#1},
    top couleur/.style={fill=#1!50}
  },%
}%
...
\pgfdeclareshape{tube à essais}{
  ...
  \saveddimen\hauteurphase{\pgf@x=\pgfkeysvalueof{/tikz/remplissage}}%高程
...
\pgfdeclareshape{bouchon de tube à essais}{
  ...
  \behindbackgroundpath{ %
    \path[draw,fill=gray] (-0.6,0.4) --++(0.1,-0.4)
      --++(0,-0.4)to[bend right]
      ++(1,0)--++(0,0.4)--++(0.1,0.4)++(-0.6,0) circle [x radius=0.6,
      y radius=0.12]--cycle ;%
  }%
}
...
\pgfdeclareshape{ballon}{
  ...
  \behindbackgroundpath{ %
    ...
    \path[draw=white,top couleur] (0,{\hauteurphase-2cm}) circle [x
      radius=((3.2 cm-\hauteurphase)*\hauteurphase)^0.5, y radius=0.1 cm];%
  }%
}
...
\pgfdeclareshape{ballon avec bouchon}{
  ...
  \inheritbehindbackgroundpath[from={ballon}]
  \backgroundpath{ %
...
\pgfdeclareshape{erlenmeyer avec bouchon}{
  ...
  \inheritbehindbackgroundpath[from={erlenmeyer}]
  \backgroundpath{ %
    \path[draw,fill=gray] (0,2)++(-0.6,0.4) --++(0.1,-0.4)
      --++(0,-0.4)to[bend right]
      ++(1,0)--++(0,0.4)--++(0.1,0.4)++(-0.6,0) circle [x radius=0.6, y
