...
// 日期：2017年11月19日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT Traversal(void *ptr, size_t count, size_t size, itemFuncType pf)
{
...
// 作者：耿楠
// 注意：[static] --- static的目的是仅在此文件中使用该函数
// 日期：2017年11月19日
//-----------------------------------------------------------------------------------------------
...
// 日期：2017年11月19日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericBubbleSort(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
...
// 日期：2017年11月24日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericSelectSort(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
    for(int i = 0; i < count; i++ )
    {
        int selpos = i;
...
// 日期：2017年11月24日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericInsertSort(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
    int i = 1;
    int j;
...
// 日期：2017年11月21日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericRecursiveBubbleSort(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
    if(count < 2)
    {
        return;
...
// 日期：2017年11月21日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericRecursiveSelectSort(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
...
// 日期：2017年11月21日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericRecursiveInsertSort(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
    // 最简情况，结束递归
    if (count <= 1)
    {
...
// 日期：2017年11月24日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericIterativeQuickSort(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
...
// 日期：2017年11月24日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericQuickSortRecursiveByFirst(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
...
// 日期：2017年11月24日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericQuickSortRecursiveByMedian(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
...
// 日期：2017年11月27日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericQuickSortRecursiveByLast(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
...
// 日期：2017年11月27日
//-----------------------------------------------------------------------------------------------
void DLL_EXPORT GenericQuickSortRecursiveByMiddle(void *ptr, size_t count, size_t size, cmpFuncType comp)
{
